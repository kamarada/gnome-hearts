...
sys.path.append("/usr/local/share/gnome-hearts");
sys.path.append("/usr/local/share/gnome-hearts/players");

from definitions import *
from stock_ai import *

# Load all the available player AI's
for script in os.listdir(os.path.abspath("/usr/local/share/gnome-hearts/players")):
